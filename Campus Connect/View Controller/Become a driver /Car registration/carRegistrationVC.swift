...
class carRegistrationVC: UIViewController, UINavigationControllerDelegate {

    @IBOutlet weak var carRegistrationImg: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        if CarRegistImg != nil {
            ...
            carRegistrationImg.image = CarRegistImg
    ...
    @IBAction func cameraBtnPressed(_ sender: Any) {
        ...
        let sheet = UIAlertController(title: "Upload your car registration", message: "", preferredStyle: .actionSheet)
    ...
    func getImage(image: UIImage) {
        ...
        carRegistrationImg.image = image
        previewView.isHidden = false
    ...
    @IBAction func DoneBtnPressed(_ sender: Any) {
        ...
        isCarRegistrationDone = true
        CarRegistImg = carRegistrationImg.image
        self.dismiss(animated: true, completion: nil)
    }
...
extension carRegistrationVC: UIImagePickerControllerDelegate {
